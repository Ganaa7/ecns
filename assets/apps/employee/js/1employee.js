...
$(document).ready(function () {
    ...
    $("#section_id", "#create").change(function () {
        ...
        filter_pos("#create", $(this).val(), "position");

    }), $("#section_id", "#edit").change(function () {

        filter("#edit", $(this).val(), "sector")

        filter_pos("#edit", $(this).val(), "position");
    })
});
...
function jqgrid() {
    ...
    $("#grid").jqGrid({
        url: base_url + "/user/index/grid",
        datatype: "json",
        mtype: "GET",
        colNames: ["#", "Хэсэг", "Тасаг", "Нэр", "Албан тушаал", "Имэйл", "Нэвтрэх.нэр", "Ажлын утас"],
        colModel: [{
            name: "employee_id",
            index: "employee_id",
            width: 15,
...
function edit_modal(e, t) {
    ...
    $("input[name=employee_id]", edit).val(e), $.ajax({

        type: "POST",

        url: base_url + "/user/index/get",
        ...
        success: function(e) {
            ...
            $("#section_id option[value=" + e.section_id + "]", edit).attr("selected", "selected"), 

            $("#sector_id option[value=" + e.sector_id + "]", edit).attr("selected", "selected"), 

            $("#position_id option[value=" + e.position_id + "]", edit).attr("selected", "selected"), 
            
            $("#first_name", edit).val(e.first_name), 
            
            $("#last_name", edit).val(e.last_name), 

            $("#username", edit).val(e.username), 
            
            $("#password", edit).val(e.password), 
            
            $("#re_password", edit).val(e.password),
...
function filter(e, t, i) {
    $.post(base_url + "/user/index/filter", {
        id: t
    }, function(t) {
...
function filter_pos(e, t, i) {
    $.post(base_url + "/user/index/filter_pos", {
        id: t
    }, function(t) {
