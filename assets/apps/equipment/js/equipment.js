...
$(document).ready(function() {
    ...
    $("#spare_id_type", "#create").change(function () {

        if($(this).val()==1){

            // show the div spare_parent
            if ( $('#section_id', '#create').val() !==0 && $("sector_id", "#create").val() !==0){
                
                // CALL AJAX show parents
               
                $.post(base_url + '/equipment/lists/get_spare', {

                    section_id: $('#section_id', '#create').val(),

                    sector_id: $('#sector_id', '#create').val()

                }, function (newOption) {
                    
                    var select = $('#equipment_spare_id', "#create");
                    if (select.prop) {
                    ...
                    $('option', '#equipment_spare_id').remove();
                ...
                alert('Хэсэг, тасаг, төхөөрөмжийн нэрийг оруулна уу!');
