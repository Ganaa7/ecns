...
$( function() {
 ...
 $.contextMenu({
    ...
    callback: function(key, options) {
        ...
        var m = "Одоогоор энэ фүнкц идэвхгүй байна: " + key;
            ...
            ?>
                 "delete": {name: "Устгах", icon: "delete",
                     ...
                     callback: function(itemKey){
                          ...
                          var is_confirm = confirm("Энэ байршлийн мэдээлллийг устгахдаа итгэлтэй байна уу?");
                          ...
                          if(is_confirm){
                              ...
                              $.ajax({
                                 ...
                                 url:    base_url+'/settings/locations/index/delete',
