...
function set_section(){   
  var str="", cnt=0;
   ...
   //if(cnt>1)
    ...
    str = ':Бүгд;ТТИХ:ТТИХ;Холбоо:Холбоо;Навигаци:Навигаци;Ажиглалт, автоматжуулалт:Ажиглалт, автоматжуулалт;Гэрэл суулт, цахилгаан:ГСЦ';
   return str;
}
