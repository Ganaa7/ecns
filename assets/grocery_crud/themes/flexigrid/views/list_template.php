...
<div id='list-report-success' class='report-div success report-list'
	<?php if($success_message !== null){?> style="display: block" <?php }?>><?php
...
<div class="flexigrid" style='width: 100%;'
	data-unique-hash="<?php echo $unique_hash; ?>">
	...
	<div class="mDiv">
		...
		<div title="<?php echo $this->l('minimize_maximize');?>"
			class="ptogtitle">
			<span></span>
		</div>
	</div>
	...
	<div class="tDiv">
		...
		<div class="tDiv3">
			<?php if(!$unset_export) { ?>
        	<a class="export-anchor" data-url="<?php echo $export_url; ?>"
					target="_blank">
					<div class="fbutton">
						<div>
	...
	<div class="sDiv quickSearchBox" id='quickSearchBox'>
			...
			<?php echo $this->l('list_search');?>: <input type="text"
				...
				<?php }?>
					...
					value="<?php echo $this->l('list_search');?>" class="crud_search"
					id='crud_search'>
			</div>
			...
			<div class="pDiv2">
				<div class="pGroup">
					<div class="pSearch pButton quickSearchButton"
						...
						title="<?php echo $this->l('list_search');?>">
						<span></span>
					</div>
				</div>
				<div class="btnseparator"></div>
				<div class="pGroup">
					...
					<?php foreach($paging_options as $option){?>
						<option value="<?php echo $option; ?>"
							<?php if($option == $default_per_page){?> selected="selected"
							<?php }?>><?php echo $option; ?>&nbsp;&nbsp;</option>
					<?php }?>
				</select> <input type='hidden' name='order_by[0]'
						id='hidden-sorting' class='hidden-sorting'
				...
				<div class="btnseparator"></div>
				<div class="pGroup">
					<span class="pcontrol"><?php echo $this->l('list_page'); ?> <input
						name='page' type="text" value="1" size="4" id='crud_page'
						class="crud_page">
