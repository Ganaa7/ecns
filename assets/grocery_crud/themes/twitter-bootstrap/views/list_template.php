	...
	<div id="main-table-box">
		...
		<div id="options-content" class="span12">
			...
			if (! $unset_add || ! $unset_export || ! $unset_print) {
				...
				class="add-anchor btn"> <i class="icon-plus"></i>
				...
				if (! $unset_export) {
					?>
		 			<a class="export-anchor btn" data-url="<?php echo $export_url; ?>"
				rel="external"> <i class="icon-download"></i>
			...
			?>
 			<a class="btn" data-toggle="modal" href="#filtering-form-search"> <i
				class="icon-search"></i>
		...
		<div id="message-box" class="span12">
			<div
				class="alert alert-sucess <?php echo ($success_message !== null) ? '' : 'hide'; ?>">
		...
		<div class="pGroup span12">
			<select name="tb_per_page" id="tb_per_page">
				<?php foreach($paging_options as $option){?>
					...
					<?php echo ($option == $default_per_page) ? 'selected="selected"' : ''; ?>><?php echo $option; ?></option>
				<?php }?>
			</select> <span class="pPageStat">
				<?php
				...
				echo str_replace ( array (
						...
						$paging_starts_from,
						$paging_ends_to,
						$paging_total_results 
				), $this->l ( 'list_displaying' ) );
				?>
			</span> <span class="pcontrol">
				<?php echo $this->l('list_page'); ?>
				<input name="tb_crud_page" type="text" value="1" size="4"
				id="tb_crud_page">
				...
				<div id="modalTab">
					<div class="tab-content">
						...
						<div class="sDiv" id="quickSearchBox">
							<div class="sDiv2">
								<input type="hidden" name="page" value="1" size="4"
									id="crud_page"> <input type="hidden" name="per_page"
									id="per_page" value="<?php echo $default_per_page; ?>" /> <input
									type="hidden" name="order_by[0]" id="hidden-sorting"
								...
								<?php echo $this->l('list_search');?>: <input type="text"
									class="qsbsearch_fieldox" name="search_text" size="30"
									id="search_text"> <select name="search_field" id="search_field">
								...
								<input type="button" class="btn btn-inverse"
									data-dismiss="modal"
									value="<?php echo $this->l('list_clear_filtering');?>"
									id="search_clear">
							</div>
						</div>
						<?php echo form_close(); ?>
