     ...
     $(".chosen-select").chosen();
	   ...
	   var flag='';
		...
		$('#btn_id_sub').click(function(){
                   ...
                   // tuhain selbeg buriin taviur bolon too shirhegiig shalgah
                   // Тухайн сэлбэгийн тавиурын тоо
                   ...
                   for(var s=1; s<=total_spare; s++){
                      ...
                      for (var i = 1; i <= total_pallet; i++){        
                        ...
                        if (current_pal_qty.val()==""||current_pal_qty.val()=='0'){
...
//                        console.log('otatl'+total+'sub'+subtotal);
//                        console.log('error'+error);
                        
                   }
                   //console.log('tota'+total_pallet+'spare'+total_spare);        
                    if(error ==false){
...
<div style="margin: 15px; font-size: 90%;">
	<form action="<?=base_url();?>wh_spare/index/add_income" name="income" id="income"
		method="post">
...
/* $this->load->view('warehouse/plugin/exfilter'); */
				...
				echo "<input type='button' value='Цуцлах' name ='cancel' onclick=\"javascript:document.location='/wh_spare/index/income'\"/>";
				echo "</div>";
	...
	<script>  
        ...
        function chkPalletQty(){
            ...
            var flag=true;            
            beginQty=document.getElementById("p_cnt_"+spare_id);            
            palletQty=document.getElementsByName("spare["+spare_id+"][pallet][]");            
