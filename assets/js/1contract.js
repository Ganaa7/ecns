     ...
     var fields = $( "#action" ).serializeArray();
	   ...
	   $('input.action').each(function() {
	     ...
	     switch($(this).val()){
          ...
          default:
           action_str = action_str + "<div title='Архив' style='float:left;cursor:pointer;' class='ui-pg-div ui-inline-edit'><span onclick='outservice(" + rowObject.id + ")' class='ui-icon ui-icon-cancel'></span></div></div>";
           break;
