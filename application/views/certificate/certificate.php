...
<!-- ADD DIALOG -->
<?php echo form_open_multipart('ecns/certificate/upload_file/', 'id="add_dialog"'); ?>
...
<div class="field">
	<label for="location">Байршил:</label>      
      <?=form_dropdown('location_id',$location, null, 'style="width:250px;" id="location_id"')?>
    </div>
<div class="field">
	...
	<!--  <input type="text" size="30" name="equipment" id ="equipment" class="text ui-widget-content ui-corner-all"> -->
      <?=form_dropdown('equipment_id',$equipment, null, 'style="width:250px;" id="equipment_id"')?>
    </div>
<div class="field">
	<label for="serial_no_year">Үйлдвэрийн болон сери дугаар:</label> <input
		type="text" name="serial_no_year" id="serial_no_year"
...
<!-- <div class="field">
	...
	<textarea name="specs" id="intend_2" cols="30" rows="5"><?php //echo $equipment->intend;?></textarea>
</div> -->
<div class="field">
	<label>Олгосон он-сар-өдөр:</label> <input type="text"
		name="issueddate" id="issued_date" class="edit_date">
</div>
<div class="field">
	<label>Хүчинтэй хугацаа:</label> <input type="text" name="validdate"
		class="edit_date" id="valid_date">
</div>
<div class="field" id='_file'>
