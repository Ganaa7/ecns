...
<div style="margin: 15px; font-size: 90%;">
	...
	<form action="/ecns/warehouse/balanceDtl" name="income" method="post">
    ...
    <?
				...
				for($i = 0; $i < $count; ++ $i) {
					...
					echo "<p align='right' id='BpalletBtn'>";
					...
					echo "<p align='right'><input type='checkbox' id='$isSerialId' name='$isSerial' value='no' onclick='showAddSpare($j);'/>Сериал дугаар байгаа<input type='button' name='$addSerialname' id='$addSerialId' onclick='makeSerial($j)' value='Сериал +' /></p>";
