...
<div class="field">
  ...
  <div class="field">
    ...
    <label for="spare_id">Сэлбэгийн дугаар:</label>

    <select name="spare_id_type" id="spare_id_type">

      <option value="0">Доорх утгаас нэг утгыг сонго</option>

      <option value="1">Сэлбэгийн дугаарыг автоматаар олгох /Шинэ төхөөрөмж/</option>

      <option value="2">Өмнө хадгалагдсан төхөөрөмжийн сэлбэгийн дугаарыг авна.</option>

    </select>

  </div>

  <div class="field" id="spare_parent">

    <label for="spare_id">Сэлбэгийн дугаар сонгох төхөөрөмжүүд:</label>

    <select name="equipment_spare_id" id="equipment_spare_id">
