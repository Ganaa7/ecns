...
<table class="login" border="0" width="470" cellpadding="2"
		...
		<tr>
			...
			<td><input type="text" name="username" title="username" value="<?php if(isset($_COOKIE["username"])) { echo $_COOKIE["username"]; }?>"
		...
		<tr>
			...
			<td><input name="password" type="password" title="Password" value="<?php if(isset($_COOKIE["password"])) { echo $_COOKIE["password"]; }?>"
				size="40" maxlength="2048" class="login" /></td>
		</tr>
		<tr>
			<td></td>
			<td><input type="checkbox" name="remember_me" value="1"
				<? if(isset($_COOKIE['username'])){   echo "checked='checked'";  }else { echo ''; } ?>>Намайг
				сана</td>
		</tr>
		<tr>
			<td></td>
