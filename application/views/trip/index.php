<?php $this->load->view('/trip/header', $this->data);?>
<?php echo $trip;?>

 
<?php echo form_open('#', array('name'=>'create-form', 'id'=>'create-form', 'title'=>'Шинэ томилолт')); ?>
...
<p class="feedback"></p>	
    ...
    <div>
      <i style="font-size:10pt;">Доорх байршлуудаас сонгож оруулна уу! Эхлэх цэг Улаанбаатар, төгсөх цэг Улаанбаатар байхыг анхаарна уу!</i>
    </div>
	    <!-- <ul id="trip"></ul> -->
	    <div id="wrapper-tag">        
	    	<!-- <span class="btn-tag" id="tag_21">Улаанбаатар 
	    	</span>
        <span>-></span> -->
	    </div>	   

	    <!-- <input type="hidden" name="route_id[]" id='route_id' class="route" value="21">  -->
		<!-- <span id="tag"></span> -->
	</div>
	<div  class="field">
	...
	<div  class="field">
		...
		<?=form_dropdown('purpose', $purpose, "id='purpose'");?>
	</div>
	<div class="field">
		<label for="end_dt">Тээврийн хэрэгсэл:</label> 
		<?php
		$transport = array('Машин'=>'Машин', 'Онгоц'=>'Онгоц');
		echo form_dropdown('transport', $transport, "id='transport'");?>
	</div>
	<div class="field">
		<label for="">Эхлэх огноо:</label> 
		<?=form_input('start_dt', null, "id='start_dt' class='start_dt'");?>
	</div>
	<div class="field">
		<label for="end_dt">Дуусах огноо:</label> 
		<?=form_input('end_dt', null, "id='end_dt'");?>
	</div>
...
<!-- go dialog -->
<div id="go-form" title="Гарсан цаг">
<p class="feedback"></p>
<?php echo validation_errors();?>
<?php echo form_open(); ?>
  <div class="field">
    <label for="spot">Гарах</label>     
    <input type="text" name='from_route' id='from_route' disabled="true">
  </div>  
  <div class="field">
    <label for="action_dt">Очих:</label>    
  ...
  <div class="field" style="width: 500px;">
    ...
    <input type="text" name="out_dt" id="out_dt_">
  </div>
  <div class="field" style="width: 500px;">
  ...
  <br>
  <i><b>Гарсан</b> цагийг өөрчлөхөд <b>Очих цаг</b> автоматаар өөрчлөгдөхийг анхаарна уу!</i>
<?php echo form_close();?>
</div>
...
<!-- comment dialog -->
<div id="comment-form" title="Тэмдэглэл">
<p class="feedback"></p>
<?php echo validation_errors();?>
<?php echo form_open(); ?>  
  <div class="field">
  ...
  <div class="field" style="width: 500px;">
    <label for="section">Очсон цаг:</label> 
    <input type="text" name="est_dt" id="est_dt" disabled="true">
  </div>
  <div class="field" style="width: 500px;">
