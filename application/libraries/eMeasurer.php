...
class eMeasurer_Driver extends eMeasurer_Modeler {
...
;
	...
	protected function add_node_validation() {
		...
		$form_validation = $this->form_validation ();
		$form_validation->set_rules ( 'module', 'Дэд хэсэг', 'required' );
...
class eMeasurer extends eMeasurer_Driver {
	private $controller;
	private $method;
	private $state;
	private $cert_id;
